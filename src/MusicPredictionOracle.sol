...
contract MusicPredictionOracle {
    ...
    event PredictionVerified(uint256 indexed predictionId, bool actualOutcome, address indexed verifier);
    ...
    function storePrediction(
        ...
        emit PredictionStored(predictionId, msg.sender, _songId, _hitProbability, _isPredictedHit, _modelVersion);
     ...
     */
    function getPredictorHistory(address _predictor) external view returns (uint256[] memory) {
